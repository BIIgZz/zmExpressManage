 ...
 * @Version: V1.0
 */
@ApiModel(value="zm_waybills对象", description="运单全表")
@Data
@TableName("zm_waybills")
public class ZmWaybills implements Serializable {
