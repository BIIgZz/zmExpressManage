...
public class ZmSupplierController extends JeecgController<ZmSupplier, IZmSupplierService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_supplier-分页列表查询")
	@ApiOperation(value="zm_supplier-分页列表查询", notes="zm_supplier-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_supplier-添加")
	@ApiOperation(value="zm_supplier-添加", notes="zm_supplier-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_supplier-编辑")
	@ApiOperation(value="zm_supplier-编辑", notes="zm_supplier-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_supplier-通过id删除")
	@ApiOperation(value="zm_supplier-通过id删除", notes="zm_supplier-通过id删除")
	@DeleteMapping(value = "/delete")
	public Result<?> delete(@RequestParam(name="id",required=true) String id) {
		zmSupplierService.removeById(id);
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_supplier-批量删除")
	@ApiOperation(value="zm_supplier-批量删除", notes="zm_supplier-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "zm_supplier-通过id查询")
	@ApiOperation(value="zm_supplier-通过id查询", notes="zm_supplier-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, ZmSupplier zmSupplier) {
        return super.exportXls(request, zmSupplier, ZmSupplier.class, "zm_supplier");
    }
